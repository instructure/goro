...
const { validate } = require('./JojoUtils');
const {
  shape,
  string,
  instanceOf,
  ...
  func,
  object
} = require('react-schema').PropTypes;

function JojoTracker(dependencies) {
  validate(shape({
    config: shape({
      ...
      continue: bool.isRequired,
      focus: bool.isRequired,

      grep: string.isRequired,
      grepDir: string.isRequired,

      cache: bool.isRequired,
      cachePath: string.isRequired,

      watchPattern: string.isRequired,

      watchSources: bool.isRequired,
      watchSourcePattern: string.isRequired,

      exclude: arrayOf(string).isRequired,
    }).isRequired,

    console: object.isRequired,

    onChange: func.isRequired,
  }), dependencies, 'JojoTracker');
